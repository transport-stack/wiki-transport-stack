...
[Open Transit Data Service APIs GitLab Repository](https://gitlab.com/transport-stack/open-transit-data-service-apis)

---

_Navigate the sidebar to explore detailed data models for Bus, Metro, Data Exchange, Accessibility, and Shared Mobility._
